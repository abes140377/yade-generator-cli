...
const expectedUsage = [
  'A fast, minimalistic backend framework for Dart.\n'
      ...
      '  create      Creates a new YADE app.\n'
      '  daemon      Start the YADE daemon\n'
      '  dev         Run a local development server.\n'
      '  list        Lists the routes on a YADE project.\n'
      '  new         Create a new route or middleware for yade\n'
      '  uninstall   Explains how to uninstall the YADE CLI.\n'
